    ...
    S: MatrixRef<T>
{
     ...
     * ```
     *
     * NOTE: In previous versions (1.7.1), this erroneously did not clip the IndexRange input to
 ...
 *
 * NOTE: In previous versions (1.7.1) this did not saturate when attempting to subtract the
 ...
 *
 * NOTE: In previous versions (1.7.1), this was erroneously implemented as conversion from a tuple
 * of start and end, not start and length as documented.
 */
 ...
 *
 * NOTE: In previous versions (1.7.1), this was erroneously implemented as conversion from an
