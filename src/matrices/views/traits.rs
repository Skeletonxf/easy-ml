...
// TODO: This should become a doc example that explains how to use dyn and trait objects with
// MatrixViews
#[test]
fn mut_methods_on_trait_objects() {
    ...
    // # SAFTEY
    // Box doesn't introduce any interior mutability, so we can implement if the type we box does.
